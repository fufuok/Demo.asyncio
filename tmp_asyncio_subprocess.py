...
"""
    ...
    Update 2019-06-28: Fixed a problem where the loop got closed prematurely,
                       added better progress messages, tested on Python 3.7.3.
...
def main():
    ...
    if platform.system() == "Windows":
        ...
        commands = [["du", "-sh", "/var/tmp"], ["ping", "-i0.1", "-c 20", "1.1.1.1"], ["hostname"]]
